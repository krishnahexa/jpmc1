...
variable "subnets" {
  ...
  default     = [
  "subnet-02135f009a70d09c8",
  "subnet-0dfcaac27a957ab00",
  "subnet-04cdd2f88fc753eba",
  "subnet-06b2497810316034a",
]
}
...
#     value = string
#   }))
#   default     = [{ name ="default", value ="default.redis5.0.cluster.on"}]
