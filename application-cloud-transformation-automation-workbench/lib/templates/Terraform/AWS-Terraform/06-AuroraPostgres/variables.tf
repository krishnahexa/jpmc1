...
variable "publicly_accessible" {
  description = "Whether the DB should have a public IP address( publicly accessible DBInstance.  The specified VPC does not support DNS resolution, DNS hostnames, or both)"
  type        = bool
  default     = false
}
...
variable "password" {
  description = "Master DB password(Only printable ASCII characters besides '/', '@', '\"', ' ' may be used)"
  type        = string
